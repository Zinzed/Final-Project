...
class template(models.Model):
    ...
    p1ProgressImg1 = models.ImageField(upload_to='projectImages/', null=True, blank=True)
    p1ProgressImg2 = models.ImageField(upload_to='projectImages/', null=True, blank=True)
    p1ProgressImg3 = models.ImageField(upload_to='projectImages/', null=True, blank=True)
    ...
    p2FinalImg = models.ImageField(upload_to='projectImages/', null=True, blank=True)
    p2FinalCap = models.CharField(max_length=50, default="final product caption")
    p2ProgressImg1 = models.ImageField(upload_to='projectImages/', null=True, blank=True)
    p2ProgressImg2 = models.ImageField(upload_to='projectImages/', null=True, blank=True)
    p2ProgressImg3 = models.ImageField(upload_to='projectImages/', null=True, blank=True)
    ...
    p3FinalImg = models.ImageField(upload_to='projectImages/', null=True, blank=True)
    p3FinalCap = models.CharField(max_length=50, default="final product caption")
    p3ProgressImg1 = models.ImageField(upload_to='projectImages/', null=True, blank=True)
    p3ProgressImg2 = models.ImageField(upload_to='projectImages/', null=True, blank=True)
    p3ProgressImg3 = models.ImageField(upload_to='projectImages/', null=True, blank=True)
    ...
    p4FinalImg = models.ImageField(upload_to='projectImages/', null=True, blank=True)
    p4FinalCap = models.CharField(max_length=50, default="final product caption")
    p4ProgressImg1 = models.ImageField(upload_to='projectImages/', null=True, blank=True)
    p4ProgressImg2 = models.ImageField(upload_to='projectImages/', null=True, blank=True)
    p4ProgressImg3 = models.ImageField(upload_to='projectImages/', null=True, blank=True)
